...
test.describe("Invalid Add User Address Tests - Invalid Singular Input Format", () => {
    ...
    // Test 007aa -> invalid add user address test - invalid address city format (special symbols only) (the error wasn't triggered, test has failed)
    test("Invalid Add User Address Test - Invalid City Format", async ({page}) => {
        //launch the page
        await page.goto('/');
        //navigate to signup page test
        await testMethods.navigateToSignUpPageTest(page);
        ...
        //valid user login test
        await testMethods.validUserLoginTest(page)
        //invalid add user address test - invalid address city format (special symbols only)
        await testMethods.invalidAddUserAddressInvalidCityFormatTest(page);
    });

    // Test 007ab -> invalid add user address test - invalid address state format (special symbols only) (the error wasn't triggered, test has failed)
    test("Invalid Add User Address Test - Invalid State Format", async ({page}) => {
        //launch the page
        await page.goto('/');
        //navigate to signup page test
        await testMethods.navigateToSignUpPageTest(page);
        ...
        //valid user login test
        await testMethods.validUserLoginTest(page)
        //invalid add user address test - invalid address state format (special symbols only)
        await testMethods.invalidAddUserAddressInvalidStateFormatTest(page);
    });

    // Test 007ac -> invalid add user address test - invalid address country format (special symbols only) (the error wasn't triggered, test has failed)
    test("Invalid Add User Address Test - Invalid Country Format", async ({page}) => {
        //launch the page
        await page.goto('/');
        //navigate to signup page test
        await testMethods.navigateToSignUpPageTest(page);
        ...
        //valid user login test
        await testMethods.validUserLoginTest(page)
        //invalid add user address test - invalid address country format (special symbols only)
        await testMethods.invalidAddUserAddressInvalidCountryFormatTest(page);
    });

    // Test 007ad -> invalid add user address test - invalid address post code format (special symbols only) (the error wasn't triggered, test has failed)
    test("Invalid Add User Address Test - Invalid Post Code Format", async ({page}) => {
        //launch the page
        await page.goto('/');
        //navigate to signup page test
        await testMethods.navigateToSignUpPageTest(page);
        ...
        //valid user login test
        await testMethods.validUserLoginTest(page)
        //invalid add user address test - invalid address post code format (special symbols only)
        await testMethods.invalidAddUserAddressInvalidPostCodeFormatTest(page);
    });
