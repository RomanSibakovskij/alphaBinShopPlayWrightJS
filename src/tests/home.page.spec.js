...
test.describe("Add Multiple Featured Products To Wishlist Test", () => {

    // Test 012b -> add multiple featured products ("SanDisk Extreme Pro 3.0 USB-C Memory Card Reader", "HP LaserJet Pro MFP M428fdw Wireless Printer", "Epson EF-100 Smart Portable Projector") to wishlist test (as a guest)
    test("Add Multiple Featured Products To Wishlist Test (as a guest)", async ({page}) => {
        //launch the page
        await page.goto('/');
    ...
    // Test 012c -> add multiple featured products ("SanDisk Extreme Pro 3.0 USB-C Memory Card Reader", "HP LaserJet Pro MFP M428fdw Wireless Printer", "Epson EF-100 Smart Portable Projector") to wishlist test (as a registered user)
    test("Add Multiple Featured Products To Wishlist Test (as a registered user)", async ({page}) => {
        //launch the page
        await page.goto('/');
        //navigate to signup page test
        await testMethods.navigateToSignUpPageTest(page);
